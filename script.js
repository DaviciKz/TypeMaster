...
const LEVELS = {
  ...
  4:{label:'Mahir',words:["bertanggungjawab","memperhatikan","mengembangkan","meningkatkan","mempertimbangkan","melaksanakan","menyelesaikan","mendapatkan","membutuhkan","menggunakan","perkembangan","pembangunan","peningkatan","pengembangan","pertumbuhan","perubahan","pengelolaan","internasional","nasional","tradisional","modern","kontemporer","inovatif","profesional","infrastruktur","telekomunikasi","transportasi","administrasi","organisasi","koordinasi","bekerjakeras","belajarsungguh","tidakmenyerah","terusberusaha","pantangmundur"]},
  5:{label:'Master',words:["belajardengansungguhsungguh","bekerjakerassetiaphari","janganpernahmenyerahpadamimpi","hidupadalahperjuanganyangindah","ilmupengetahuanadalahcahayakehidupan","keluargaadalahhartapalingberharga","waktutidakbisadiputarkembali","setiaplangkahkecilmembawaperubahan","konsistensiadalahkuncikesuksesan","teknologimengubahcarakitabekerja","pendidikanmembukapintukesempatan","Indonesiaadalahnegarakepulauanterbesar","bahasaIndonesiamenyatukanbangsa","gotongroyongadalahjiwabangsaIndonesia","membacabukumemperluaswawasankita","menghadapitantangandenganpenuhkeberanian","belajardarikesalahanadalahhalbijaksana"]}
};
